  ...
  "inline-flex items-center gap-1 rounded-full border px-2 py-0.5 text-[10px] font-semibold uppercase tracking-wider transition",
  {
    variants: {
      variant: {
        ...
        tierA: "border-transparent bg-emerald-500/15 text-success",
        tierB: "border-transparent bg-sky-500/15 text-info",
        tierC: "border-transparent bg-amber-500/15 text-warning",
        tierD: "border-transparent bg-orange-500/15 text-warning",
        tierF: "border-transparent bg-rose-500/15 text-danger",
      },
    },
