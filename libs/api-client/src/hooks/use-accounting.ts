...
export const accountingKeys = {
  ...
  trialBalance: (asOf?: string) => ['accounting', 'reports', 'trial-balance', asOf ?? ''] as const,
  incomeStatement: (from?: string, to?: string) =>
    ['accounting', 'reports', 'income-statement', from ?? '', to ?? ''] as const,
...
export function useSeedChart() {
  ...
  return useMutation({
    ...
    onSuccess: () => qc.invalidateQueries({ queryKey: accountingKeys.accounts }),
  });
}
...
export function useJournalEntries(params?: { from?: string; to?: string; source?: string }) {
  ...
  return useQuery({
    ...
    queryFn: () =>
      getApiClient().get<JournalEntry[]>(`/accounting/journal${qs ? `?${qs}` : ''}`),
  });
}
...
export function useJournalEntry(id: string | null) {
  return useQuery({
    ...
    queryFn: () => getApiClient().get<JournalEntry>(`/accounting/journal/${id}`),
    enabled: Boolean(id),
  });
}
...
export function useTrialBalance(asOf?: string) {
  ...
  return useQuery({
    ...
    queryFn: () =>
      getApiClient().get<TrialBalanceReport>(`/accounting/reports/trial-balance${qs}`),
  });
}
...
export function useBalanceSheet(asOf?: string) {
  ...
  return useQuery({
    ...
    queryFn: () =>
      getApiClient().get<BalanceSheetReport>(`/accounting/reports/balance-sheet${qs}`),
  });
}
...
export function useLoanPortfolio(asOf?: string) {
  ...
  return useQuery({
    ...
    queryFn: () =>
      getApiClient().get<AgingReport>(`/accounting/reports/loan-portfolio${qs}`),
  });
}
...
export function usePeriods() {
  return useQuery({
    ...
    queryFn: () => getApiClient().get<AccountingPeriod[]>('/accounting/periods'),
  });
}
...
export function useAccrueInterest() {
  ...
  return useMutation({
    mutationFn: (p: { year?: number; month?: number } = {}) =>
      getApiClient().post<AccrualJobResult>('/accounting/jobs/accrue-interest', p),
