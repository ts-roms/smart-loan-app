...
// SVG is intentionally allowed for `branding/` only — operators want
// vector logos for crisp rendering at every size. The other subdirs
// stay raster-only since SVG-as-attachment opens an XSS vector.
