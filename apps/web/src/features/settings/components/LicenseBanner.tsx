...
export function LicenseBanner() {
  ...
  const className =
    tone === "rose"
      ? "flex items-center gap-2 border-b border-rose-500/30 bg-rose-500/10 px-4 py-2 text-xs text-rose-100"
      : "flex items-center gap-2 border-b border-amber-500/30 bg-amber-500/10 px-4 py-2 text-xs text-amber-100";
