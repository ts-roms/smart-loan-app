...
import { ArrowUpRight, CreditCard, ShieldCheck, UserCircle } from 'lucide-react';
...
function CustomerSummaryInspector({ customerId }: { customerId: string }) {
  ...
  const { customer, activeLoansCount, totalLoansCount, outstanding, activeLoans } = summary.data;
      ...
      <DrawerBody>
        ...
        <div className="grid grid-cols-2 gap-2">
          ...
          <div className="rounded-md border border-white/10 bg-white/[0.03] p-2">
            ...
            <div className="text-xs text-white mt-1">{customer.employmentStatus}</div>
