      ...
      <Dialog open={approveOpen} onOpenChange={setApproveOpen}>
        <DialogContent>
          ...
          <textarea
            ...
            rows={4}
            className="w-full rounded-md border border-default bg-surface-2 px-3 py-2 text-sm placeholder:text-fg-subtle focus:outline-none focus-visible:ring-2 focus-visible:ring-sky-400/60"
          />
          <DialogFooter>
